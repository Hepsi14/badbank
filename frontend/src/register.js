...
export default function Create(){
    ...
    return (
        <>
        <center>
        <div className="forms" style={{backgroundImage:"url('https://thumbs.dreamstime.com/b/registration-online-membership-network-internet-business-technology-concept-104512007.jpg')", backgroundRepeat:'no-repeat',backgroundSize:'100% 100%'}}>
          <label>
       
          <div >
            <h1 style={{color:'yellow'}}>Create Account</h1>
            </div>
               <input
                  type="text"
