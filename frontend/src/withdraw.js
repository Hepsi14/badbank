...
<center>
<div className="forms" style={{backgroundImage:"url('http://www.papertyari.com/wp-content/uploads/2019/11/acceptance-of-deposit.jpg')", backgroundRepeat:'no-repeat',backgroundSize:'100% 100%'}}>
  
  <h4 style={{color:'yellow'}}>Withdraw Amount- Current Balance is <b style={{color:'red'}}>${bal}</b></h4>
  <br></br>
  <label>
  <input
							type="number"
