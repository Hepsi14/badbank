...
<center>
<div className="deposit" style={{backgroundImage:"url('https://www.idfcfirstbank.com/content/dam/idfcfirstbank/images/blog/what-is-fixed-deposit-meaning-features-717x404.jpg')", backgroundRepeat:'no-repeat',backgroundSize:'100% 100%'}}> 
  
  <h4>Deposit Amount - Current  Balance is <b style={{color:'green'}}>${bal}</b></h4>
  <br></br>
  <label>
  <input
							type="number"
